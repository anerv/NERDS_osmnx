...
if __name__ == "__main__":
    ...
    ###showcase
    # print('Node 282416811 in 12.55365, 55.62000')
    # print('Show hard simplification with seed 2550024')
    # print(simple_metro.edges[282416811,282416810,0],
    #       simple_metro.edges[282416810, 282416811, 0],
    #       simple_metro.edges[2385052491, 282416811, 0],
    #       simple_metro.edges[282416811, 2385052491, 0])